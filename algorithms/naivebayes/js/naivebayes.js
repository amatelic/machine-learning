...
let cl = new FisherClassifier(getWords);

sampletrain(cl);

console.log(cl.classify('you are a good friend'));
console.log(cl.classify('playing sex game'));
cl.setMinimum('bad', 0.8);
console.log(cl.classify('playing'));
